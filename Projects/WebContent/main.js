...
//***************************Evaluate Handler******************************************//
let e1_btn = document.getElementById("e1");
let e2_btn = document.getElementById("e2");
let e3_btn = document.getElementById("e3");
let e4_btn = document.getElementById("e4");
let e5_btn = document.getElementById("e5");
let e6_btn = document.getElementById("e6");
let calculating = document.getElementById("calculate");

if(e1_btn){
	e1_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
if(e2_btn){
	e2_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
if(e3_btn){
	e3_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
if(e4_btn){
	e4_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
if(e5_btn){
	e5_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
if(e6_btn){
	e6_btn.addEventListener("click", function(){
		show_elem(calculating)
	}, false)
}
